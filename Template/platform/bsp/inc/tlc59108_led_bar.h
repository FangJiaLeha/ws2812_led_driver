 ...
 *
 */
typedef struct tlc59108_render_param{
...
typedef struct tlc59108_bar
{
    ...
    // tlc59108灯条的blink方法
    Rtv_Status (*blink)(void *bar,
                        const uint16_t led_out_state,
                        const uint8_t *pwmx_value);
    // tlc59108灯条的dimming方法
    Rtv_Status (*dimming)(void *bar,
                          const uint8_t *pwmx_value);
}TLC59108BarType;
typedef TLC59108BarType* TLC59108BarType_t;
 ...
 * @return Rtv_Status   @SUCCESS:初始化TLC59108灯条成功 @其他值:初始化TLC59108灯条失败
 */
 ...
 *
 * @note  该接口主要用来处理TLC59108灯条的blinking/dimming模式
 *
 */
